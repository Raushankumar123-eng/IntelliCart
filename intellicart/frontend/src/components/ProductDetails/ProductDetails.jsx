                            ...
                            <div className="flex-1 py-2 px-3">
                                ...
                                <div className="flex flex-col gap-2 mb-4">
                                    ...
                                    <span className="text-sm text-gray-500 font-medium flex gap-2 items-center">
                                        <span className="text-xs px-1.5 py-0.5 bg-primary-green rounded-sm text-white flex items-center gap-0.5">{product.ratings?.toFixed(1)} <StarIcon sx={{ fontSize: "12px" }} /></span>
                                    ...
                                    {Array(3).fill("").map((el, i) => (
                                        <p className="text-sm flex items-center gap-1" key={i}>
                                            ...
                                            <span className="font-medium ml-2">Bank Offer</span> 15% Instant discount on first <b>Intellicart Pay Later</b> order of 500 and above <Link className="text-primary-blue font-medium" to="/">T&C</Link>
                                        </p>
                                    ))}

                                    <div className="flex gap-8 mt-2 items-center text-sm">
                                        <img draggable="false" className="w-20 h-8 p-0.5 border object-contain" src={product.brand?.logo.url} alt={product.brand?.name} />
                                    ...
                                    <div className="flex gap-16 mt-4 items-center text-sm font-medium">
                                        ...
                                        <Link className="font-medium text-primary-blue ml-3" to="/">{product.brand?.name}</Link>
                                    </div>

                                    {/* Intellicart Plus Banner */}
                                    <div className="sm:w-1/2 mt-4 border">
                                        <img draggable="false" className="w-full h-full object-contain" src={logo} alt="Intellicart Banner" />
                                    </div>
                                    ...
                                    <div className="w-full mt-4 rounded-sm border flex flex-col">
                                        ...
                                        <div className="flex items-center border-b">
                                            <h1 className="px-6 py-3 text-3xl font-semibold">{product.ratings?.toFixed(1)}<StarIcon /></h1>
